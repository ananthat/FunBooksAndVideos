...
public class InMemoryItemRepository : IItemRepository
{
    ...
    static InMemoryItemRepository()
    {
        ...
        var bookClub = new Membership { Id = Guid.Parse("c3d4e5f6-a7b8-99a0-b1c2-d3e4f5a6b7c8"), Name = "Book Club Membership", Type = MembershipType.BookClub };
        var videoClub = new Membership { Id = Guid.Parse("d4e5f6a7-b8c9-a0b1-c2d3-e4f5a6b7c8d9"), Name = "Video Club Membership", Type = MembershipType.VideoClub };
        var premium = new Membership { Id = Guid.Parse("e5f6a7b8-c9d0-b1c2-d3e4-f5a6b7c8d9e0"), Name = "Premium Membership", Type = MembershipType.Premium };
